document.addEventListener('DOMContentLoaded', (event) => {
    ...
    initializeDial('DMS_driverAsleepSleepDurationRange', 'DMS_driverAsleepSleepDurationNumber', 0, 60, '200px', 10);
    ...
    initializeDial('DMS_driverDistractedTurnGraceTimerRange', 'DMS_driverDistractedTurnGraceTimerNumber', 0, 60, '200px', 10);
    ...
    initializeDial('DMS_seatbeltAlertTimeRange', 'DMS_seatbeltAlertTimeNumber', 0, 60, '200px', 10);
    ...
    initializeDial('DMS_driverDisappearedTimeThresholdRange', 'DMS_driverDisappearedTimeThresholdNumber', 0, 60, '200px', 10);
    initializeDial('DMS_driverDisappearedTrackingGraceTimerRange', 'DMS_driverDisappearedTrackingGraceTimerNumber', 0, 60, '200px', 10);
    ...
    initializeDial('SI_cameraError_MessageBackoffRange', 'SI_cameraError_MessageBackoffNumber', 0, 60, '150px', 10);
});
